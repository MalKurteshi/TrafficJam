            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
					...
					<li class="ripple"><a class="tree-toggle nav-header"><span class="fa "></span><a href=""logout.php"> Logout </a> <span class="fa-angle-right fa right-arrow text-right"></span> </a></li>
                    ...
                    <div class="col-md-12 padding-0">
                        <div class="col-md-8 padding-0">
							<!--NEW MAP--><div >
								...
								<script>
								  function initMap() {
									var uluru = {lat: 40.640, lng: 22.944};
								...
								<script async defer
								src="https://maps.googleapis.com/maps/api/js?key=AIzaSyArV2USjBYl8wxtIwB6cGlFmWUGNaR7Irk&callback=initMap">
								</script>
