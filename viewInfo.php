...
<body id="mimin" class="dashboard">
	...
	//	document.getElementById('lat').innerHTML=item_Lat.val();
	  ...
	  document.getElementById("lat").innerHTML=item_Lat;
		document.getElementById("lng").innerHTML=item_Lng;
   ...
   <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyArV2USjBYl8wxtIwB6cGlFmWUGNaR7Irk&callback=initMap&libraries=places&callback=initMap"
		...
		<form>
				...
				<div class="form-group"><label class="col-sm-2 control-label text-right">Location</label>
                              <div class="col-sm-10"><input type="text" class="form-control"  name="location" id="pac-input"></div>
                            </div>
				
                            <div class="form-group"><ul id="display"></ul>
			                              
			<input class="submit btn btn-danger" onclick="clickButton()"  name="report" value="View Info">	
				</form>	
...
function clickButton()
{
  ...
  var b =document.getElementById("lat").innerHTML;
  var c =document.getElementById("lng").innerHTML;
  ...
  data.append('lat',b)
	...
	var xmlhttp = new XMLHttpRequest();
		...
		xmlhttp.open("POST", "viewInformationDB.php", true);
		xmlhttp.send(data);
}
